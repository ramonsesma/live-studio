...
<p align="center">
  ...
  63 modules · 253 tools · 84 quick actions · AI copilot · <code>⌘K</code> palette — all inside a single tabbed webview.
</p>
...
<p align="center">
  ...
  <img alt="modules" src="https://img.shields.io/badge/modules-62-ffb347" />
  <img alt="tools" src="https://img.shields.io/badge/tools-253-6cc6ff" />
...
- **63 modules** (62 visible + 1 hidden) with **253 real tools** across categories: music
...
- **AI copilot** (OpenRouter / OpenAI / OpenCode Zen) with a *tool-calling* loop: it discovers and
  runs **any of the 253 tools** through a meta-toolkit (`find_tools` searches the whole suite,
  `list_modules` browses, `run_tool` executes) — reaching everything without flooding the model.
- **Quick command palette** (`⌘K`): indexes the **253 tools** + **84 quick actions**
  (each one a shortcut that runs a real tool with preset args) and runs them with the keyboard.
- **27 curated rich panels** where the auto-generated form falls short: piano-roll, clip
...
- **Tested**: 90 end-to-end smoke tests of the server + modules.
...
<table>
  ...
  <tr>
    <td align="center">
      ...
      <sub><b>⌘K command palette</b> — mixes 253 real tools and 84 quick actions in one search.</sub>
    </td>
    <td align="center">
...
The Mix Radar is the most elaborate of the 27.
...
<details>
<summary><b>Show the 62 modules by category</b> (+ 1 hidden module backing the ⌘K palette)</summary>
...
- **MIDI & composition:** Chords & Progressions · Melody Generator · Lyric → Melody · MIDI Harmonizer · MIDI Randomizer · MIDI Transformer · MIDI Gate · MIDI LFO · Chord Pads · Step Sequencer · Quantize & Swing · Groove & Humanize · Notation Viewer · Generative Rhythm
...
- **Sound design:** Synth Patchbay · SFX & Textures · Vocal Chain & FX · Audio Texture Mapper
