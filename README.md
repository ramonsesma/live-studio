...
<p align="center">
  ...
  68 modules · 262 tools · 84 quick actions · AI copilot · <code>⌘K</code> palette — all inside a single tabbed webview.
</p>
...
<p align="center">
  ...
  <img alt="modules" src="https://img.shields.io/badge/modules-67-ffb347" />
  ...
  <img alt="rich panels" src="https://img.shields.io/badge/rich%20panels-32-9370db" />
...
- **68 modules** (67 visible + 1 hidden) with **262 real tools** across categories: music
...
- **AI copilot** (OpenRouter / OpenAI / OpenCode Zen) with a *tool-calling* loop: it discovers and
  runs **any of the 262 tools** through a meta-toolkit (`find_tools` searches the whole suite,
  `list_modules` browses, `run_tool` executes) — reaching everything without flooding the model.
- **Quick command palette** (`⌘K`): indexes the **262 tools** + **84 quick actions**
  (each one a shortcut that runs a real tool with preset args) and runs them with the keyboard.
- **32 curated rich panels** where the auto-generated form falls short: piano-roll, clip
...
- **Tested**: 110 end-to-end smoke tests of the server + modules.
...
<table>
  ...
  <tr>
    <td align="center">
      ...
      <sub><b>⌘K command palette</b> — mixes 262 real tools and 84 quick actions in one search.</sub>
    </td>
    <td align="center">
...
The Mix Radar is the most elaborate of the 32.
...
and add it to `index.html`. `shell.js` uses it instead of the autoform. There are 32 already:
...
<details>
<summary><b>Show the 67 modules by category</b> (+ 1 hidden module backing the ⌘K palette)</summary>

- **Session & project:** Session & Tracks · Clips & Scenes · Bulk Track Manager · Track Color Coordinator · Project Templates · Project Notes · Project Health · Session Organizer · Snapshots · **Project Snapshot · Git** · Sample Library Brain
- **MIDI & composition:** Chords & Progressions · Melody Generator · Lyric → Melody · MIDI Harmonizer · MIDI Randomizer · MIDI Transformer · MIDI Gate · MIDI LFO · Chord Pads · Step Sequencer · Quantize & Swing · Groove & Humanize · Notation Viewer · Generative Rhythm · Score Editor · Clip Variation Engine
- **Drums:** Drums & Patterns · Drum Replacer · Drum Map Editor · Drum Bus Processor
- **Mixing & FX:** EQ & Analysis · Compression & Dynamics · Gain Staging & Levels · AI Mixing Assistant · Mix Console View · Mix Scene Saver · FX Chains · FX Chain Presets · Macro Mapper Pro · Rack Builder · **Resonance · Mix Radar** ⭐ · Auto-Gain Stager · Key & Scale Detective · Spectrum Match
...
- **Sound design:** Synth Patchbay · SFX & Textures · Vocal Chain & FX · Audio Texture Mapper · Stem Aligner
