...
const PROFILES = {
  all: null,
  mixing: ["session", "eq", "mixconsole", "mixassistant", "compressor", "mastering", "autogain", "resonance", "spectrumcompare", "mixcoach", "health", "mixscene", "drumbus", "grouprouting", "trackmanager", "stemexport", "paramdiff", "devremote", "fxchain", "fxpresets", "vocal", "organizer", "macros", "stemalign", "warpcompare", "loopdetect", "history", "stripsilence", "audioconvert", "clipeditor", "transients"],
  sounddesign: ["synth", "sfx", "drumsynth", "slicelab", "mosaic", "riser", "sub808", "padengine", "pluckengine", "acid303", "chordstab", "fmbell", "impact", "subbass", "organ", "vocalchop", "instrumentrender", "brass", "wobble", "choir", "subdrop", "pluckbass", "sawlead", "reese", "marimba", "glitch", "tapehiss", "trumpet", "epiano", "musicbox", "harp", "whistle", "subwobble", "vocoder", "noisefx", "cymbal", "guitar", "sitar", "steeldrum", "accordion", "theremin", "hihat808", "stabhit", "glassbell", "subkick", "reversesweep", "timestretch", "texturemap", "samplebrain", "saferandom", "macromorph", "rackbuilder", "midilfo", "midigate", "audio2midi", "drumreplace", "extremestretch", "reverseverb", "iterate", "imagemidi", "drumextract", "retime"],
  performance: ["performance", "setlist", "tempotap", "quickactions", "launchquant", "sessionbridge", "clips", "chordpads", "temposync", "delaycalc", "notes", "console", "sandbox", "drummap", "stepseq", "mixscene", "history", "linkedclips", "cuesheet"],
};
