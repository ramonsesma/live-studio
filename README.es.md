...
<p align="center">
  ...
  81 módulos · 283 tools · 84 micro-acciones · copiloto IA · paleta <code>⌘K</code> — en un único webview por pestañas.
</p>
...
<p align="center">
  ...
  <img alt="tools" src="https://img.shields.io/badge/tools-283-6cc6ff" />
...
- **81 módulos** (75 visibles + 1 oculto) con **283 tools reales** repartidos por categorías:
...
- **Copiloto IA** (OpenRouter / OpenAI / OpenCode Zen) con loop de *tool-calling*: descubre y
  ejecuta **cualquiera de los 283 tools** mediante un kit de meta-tools (`find_tools` busca en
  toda la suite, `list_modules` navega, `run_tool` ejecuta) — alcanza todo sin saturar al modelo.
- **Paleta de comandos rápidos** (`⌘K`): indexa los **283 tools** + **84 quick actions**
  (cada una un atajo que ejecuta un tool real con args) y las ejecuta con teclado.
- **45 paneles ricos** curados donde el formulario automático se queda corto: piano-roll,
...
- **Probado**: 133 pruebas de humo end-to-end del servidor + módulos.
...
npm run test        # 133 pruebas de humo (servidor + módulos, song simulado)
